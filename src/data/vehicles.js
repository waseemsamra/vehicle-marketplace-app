...
const templates = [
  ...
  { make: 'Ford', model: 'Mustang GT', body: 'Coupe', fuel: 'Gasoline', transmission: 'Manual', engine: 'V8', features: ['Sport Mode'], basePrice: 42000 },
  { make: 'Ford', model: 'Mustang Shelby GT500', body: 'Coupe', fuel: 'Gasoline', transmission: 'Automatic', engine: 'V8', features: ['Sport Mode', 'Carbon Fiber'], basePrice: 75000 },
  { make: 'Ford', model: 'Mustang EcoBoost', body: 'Coupe', fuel: 'Gasoline', transmission: 'Automatic', engine: 'Inline-4', features: ['Navigation'], basePrice: 32000 },
