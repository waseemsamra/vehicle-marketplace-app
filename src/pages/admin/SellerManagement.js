    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-slate-400 mt-1">{sellers.length} total sellers</p>
            </div>
            <button
          ...
          <table className="w-full">
            <thead className="bg-slate-800/50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-400 uppercase">Business</th>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-400 uppercase">Rating</th>
            ...
            <tbody className="divide-y divide-slate-800">
              {sellers.length === 0 ? (
                ...
                sellers.map((seller) => (
                  <tr key={seller.sellerId || seller.id} className="hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="font-medium text-white">{seller.firstName} {seller.lastName}</div>
                    </td>
                    <td className="px-6 py-4 text-slate-300">{seller.businessName || '-'}</td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-white font-medium">{seller.rating || 5}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
